...
using Atendimento = ControlServices.Application.Domain.Contexts.DbAuth.Atendimentos.Atendimento;

namespace ControlServices.Infra.Data.Contexts.DbAuth.Atendimentos;
public class AtendimentoRepository(IServiceProvider serviceProvider) : BaseRepository<DbAuthContext, Atendimento>(serviceProvider), IAtendimentoRepository
{
