...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Authentication.Application.Domain.Contexts.DbAuth.Atendimentos.Atendimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Authentication.Application.Domain.Contexts.DbAuth.MapAtendimentosServicos.MapAtendimentoServico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Authentication.Application.Domain.Contexts.DbAuth.Servicos.Servico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Authentication.Application.Domain.Contexts.DbAuth.Atendimentos.Atendimento", b =>
                {
                    b.HasOne("Authentication.Application.Domain.Contexts.DbAuth.Clientes.Cliente", "Cliente")
            ...
            modelBuilder.Entity("Authentication.Application.Domain.Contexts.DbAuth.MapAtendimentosServicos.MapAtendimentoServico", b =>
                {
                    b.HasOne("Authentication.Application.Domain.Contexts.DbAuth.Atendimentos.Atendimento", "Atendimento")
                        .WithMany("MapAtendimentosServicos")
                        .HasForeignKey("AtendimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Authentication.Application.Domain.Contexts.DbAuth.Servicos.Servico", "Servico")
